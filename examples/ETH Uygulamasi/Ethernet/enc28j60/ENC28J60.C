 ...
 */
void enc28j60DumpReg(void)
{
	printf("-- enc28j60 registers:\n");
	printf("HwRevID: 0x%02x\n", enc28j60Read(EREVID));
	printf("Cntrl: ECON1 ECON2 ESTAT  EIR  EIE\n");
	printf("       0x%02x  0x%02x  0x%02x  0x%02x  0x%02x\n",enc28j60Read(ECON1), enc28j60Read(ECON2), enc28j60Read(ESTAT), enc28j60Read(EIR), enc28j60Read(EIE));
	printf("MAC  : MACON1 MACON3 MACON4\n");
	printf("       0x%02x   0x%02x   0x%02x\n", enc28j60Read(MACON1), enc28j60Read(MACON3), enc28j60Read(MACON4));
	printf("Rx   : ERXST  ERXND  ERXWRPT ERXRDPT ERXFCON EPKTCNT MAMXFL\n");
	printf("       0x%04x 0x%04x 0x%04x  0x%04x  ",
		(enc28j60Read(ERXSTH) << 8) | enc28j60Read(ERXSTL),
		(enc28j60Read(ERXNDH) << 8) | enc28j60Read(ERXNDL),
		(enc28j60Read(ERXWRPTH) << 8) | enc28j60Read(ERXWRPTL),
		(enc28j60Read(ERXRDPTH) << 8) | enc28j60Read(ERXRDPTL));
	printf("0x%02x    0x%02x    0x%04x\n", enc28j60Read(ERXFCON), enc28j60Read(EPKTCNT),
		(enc28j60Read(MAMXFLH) << 8) | enc28j60Read(MAMXFLL));

	printf("Tx   : ETXST  ETXND  MACLCON1 MACLCON2 MAPHSUP\n");
	printf("       0x%04x 0x%04x 0x%02x     0x%02x     0x%02x\n",
		(enc28j60Read(ETXSTH) << 8) | enc28j60Read(ETXSTL),
		(enc28j60Read(ETXNDH) << 8) | enc28j60Read(ETXNDL),
		enc28j60Read(MACLCON1), enc28j60Read(MACLCON2), enc28j60Read(MAPHSUP));
}
